...
public class ContactMysqlDAO {
	...
	public static Connection getConnection() throws Exception{
        String url = "jdbc:mysql://localhost:3306/contact_db?serverTimezone=UTC&allowPublicKeyRetrieval=true&useSSL=false&useUnicode=true&characterEncoding=UTF-8"; // 접속 문자열
        String user = "root"; // 사용자 이름
        String password = "a123456789"; // 비밀번호
	...
	public ContactDto modify(Integer id) throws SQLException {
		ContactDto dto = new ContactDto();
		try {
			conn = getConnection();
			String sql = " SELECT ";
