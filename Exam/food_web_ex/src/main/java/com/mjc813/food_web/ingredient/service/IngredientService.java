...
public class IngredientService {
    ...
    public Page<IngredientEntity> findByNameContainsRepository(String name, Pageable pageable) {
        Page<IngredientEntity> list = this.repository.findByNameContains(name, pageable);
        return list;
    }
